        ...
        <div className="bg-white rounded-2xl shadow-sm border border-sky-mid p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input id="confirmPassword" type={showConfirm ? "text" : "password"} placeholder="••••••••" {...register("confirmPassword")} className={errors.confirmPassword ? "border-red-300 pr-10" : "pr-10"} />
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            Вже є акаунт?{" "}
            <Link href="/login" className="text-sky-darker hover:underline font-medium">Увійти</Link>
          </div>
        </div>
      </div>
    </div>
